...
Proof.
  ...
  intros. simpl. apply f_equal. rewrite <- H. simpl. apply IHl. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  intros. rewrite <- H. simpl. apply f_equal. apply IHl1. reflexivity.
Qed.
...
Proof.
  ...
  destruct (f true) eqn:Heqf2.
  apply Heqf2.
  apply Heqf.
  destruct b.  
  destruct (f false) eqn:Heqf3.
  apply Heqf.
  apply Heqf3.
  rewrite -> Heqf. apply Heqf.
Qed.
